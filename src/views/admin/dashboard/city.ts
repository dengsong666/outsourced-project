...
export const cities = [
  ...
  { name: '上海', value: [121.48, 31.22] },
  { name: '攀枝花', value: [101.718637, 26.582347] },
  ...
  { name: '嘉峪关', value: [98.289152, 39.77313] },
  { name: '广州', value: [113.23, 23.16] },
